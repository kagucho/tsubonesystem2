...
<table class="table">
<tr>
	<th class="col-md-2 col-sm-2 col-xs-2">本名</th><th class="col-md-2 col-sm-2 col-xs-2">ハンドルネーム</th><th class="col-md-5 col-sm-5 col-xs-5">連絡先（mail）</th><th class="col-md-3 col-sm-3 col-xs-3">連絡先（電話番号）</th>
...
<table class="table">
<tr>
	<th class="col-md-2 col-sm-2 col-xs-2">部名</th><th class="col-md-2 col-sm-2 col-xs-2">代表者</th><th class="col-md-5 col-sm-5 col-xs-5">連絡先（mail）</th><th class="col-md-3 col-sm-3 col-xs-3">連絡先（電話番号）</th>
