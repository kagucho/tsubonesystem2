...
<div class="container CENTER">
	...
	<a href="<c:url value="/admin/partyDetail/${partyId}"/>"><button type="button" class="col-md-4 col-md-offset-1 col-sm-5  col-xs-12 btn btn-default btn-lg">Show.PartyDetail</button></a>
</div>
